  ...
  *----------------------------------------------------------------------------*/
  ...
  multipleRendererTest( 'External image displayed before load, then after load',
    function( scene, display, asyncCallback ) {
      ...
      img.src = '../../examples/example-image-1.png';
    ...
    0, [ 'canvas', 'webgl' ], true // asynchronous, don't test SVG/DOM, since foreignobject doesn't work with external images
  );
