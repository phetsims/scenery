...
export type { ParallelDOMOptions, PDOMValueType, LimitPanDirection, PDOMBehaviorFunction, Association, TrimParallelDOMOptions } from './accessibility/pdom/ParallelDOM.js';
