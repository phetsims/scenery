...
export type { ParallelDOMOptions, PDOMValueType, LimitPanDirection, PDOMBehaviorFunction, Association, TrimmedParallelDOMOptions } from './accessibility/pdom/ParallelDOM.js';
