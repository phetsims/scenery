...
${cubic}
${transform}
@group(0)@binding(0)var<uniform>n:aV;@group(0)@binding(1)var<storage>u:a0;@group(0)@binding(2)var<storage>b8:array<al>;struct hz{J:dc,S:dc,T:dc,V:dc,ad:h,bM:j}@group(0)@binding(3)var<storage,read_write>bP:array<hz>;@group(0)@binding(4)var<storage,read_write>eL:array<fA>;var<private>bU:j;${pathdata_util}
