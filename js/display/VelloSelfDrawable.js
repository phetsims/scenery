...
class VelloSelfDrawable extends SelfDrawable {
  /**
   * @public
   * @override
   *
...
scenery.register( 'VelloSelfDrawable', VelloSelfDrawable );

export default VelloSelfDrawable;