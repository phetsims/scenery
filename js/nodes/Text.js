...
define( function ( require ) {
  ...
  Text.prototype.updateSVGFragment = function ( element ) {
    ...
    switch( this._textAlign ) {
      case 'start':
      case 'end':
        element.setAttribute( 'text-anchor', this._textAlign );
        break;
      case 'left':
        element.setAttribute( 'text-anchor', isRTL ? 'end' : 'start' );
        break;
      case 'right':
        element.setAttribute( 'text-anchor', !isRTL ? 'end' : 'start' );
        break;
    ...
    switch( this._textBaseline ) {
      ...
      case 'hanging':
      case 'middle':
        element.setAttribute( 'dominant-baseline', this._textBaseline );
        break;
      default:
