...
define( require => {
  ...
  const SpritesCanvasDrawable = require( 'SCENERY/display/drawables/SpritesCanvasDrawable' );
  const SpritesWebGLDrawable = require( 'SCENERY/display/drawables/SpritesWebGLDrawable' );
  ...
  return scenery.register( 'Sprites', Sprites );
} );
